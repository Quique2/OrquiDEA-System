...
% Figuras recomendadas para esta sección (capturar y descomentar):
% \begin{figure}[t]
%   \centering
%   \includegraphics[width=\columnwidth]{captura_visor3d.png}
%   \caption{Vista ``Cobot en vivo'' del gemelo digital animada con
%   telemetría Modbus real a 10 Hz. [Telemetría real.]}
%   \label{fig:visor}
% \end{figure}
% \begin{figure}[t]
%   \centering
%   \includegraphics[width=\columnwidth]{captura_scada.png}
%   \caption{Panel SCADA 4.0 con los cinco pilares de analítica.}
%   \label{fig:scada}
% \end{figure}
